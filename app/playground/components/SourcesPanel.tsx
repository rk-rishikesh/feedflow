    ...
    return (
        <div className="w-96 bg-[#FFFFFF] flex flex-col">
            <div className="flex-1 overflow-y-auto p-4">
                <div className="h-full bg-[#FFFFFF] border border-[#D4D4D4] rounded-[32px] shadow-sm flex flex-col gap-4 p-4">
                    ...
                    <div className="pt-4 mt-auto border-t border-[#D4D4D4]">
                        <button
                            ...
                            className={`w-full py-3 px-4 rounded-2xl font-medium transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5 ${isGenerating
